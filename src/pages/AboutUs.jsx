            ...
            <div className="AboutUs">
                <div className="row container">
                    ...
                    <div className="col-8 mt-5">
                        ...
                        <div className="typed">
                            <p className="mt-4"><strong>"Shopping Bazaar"</strong> is an E-commerce Shopping platform that is a combination of a <strong>Website</strong> and <strong>Application</strong> <br /> <br /> That we have created separately so that users can engage with various platforms and approach us.</p>
                        </div>
                    </div>
                    <div className="typed">
